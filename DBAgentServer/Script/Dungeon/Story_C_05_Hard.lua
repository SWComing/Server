...
function PF_STORYQUEST_ALL_3_10_STAGE0_SUB0_SHOT0( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
	...
	if pSlideShot:EventTimer( 0.1 ) == true then
		...
		pSlideShot:AddText2_LUA( true, "Xiao", "Podemos entrar aqui.", 0.11, "#C6600CC" )
...
function PF_STORYQUEST_ALL_3_10_STAGE0_SUB0_SHOT1( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
	...
	if pSlideShot:EventTimer( 0.1 ) == true then
		...
		pSlideShot:SetTextBoxShow( true )
		pSlideShot:AddText2_LUA( true, "Xiao", "嗯～我都闻到了洞外的花香味呢！", 0.11, "#C6600CC" )
...
function PF_STORYQUEST_ALL_3_10_STAGE0_SUB0_SHOT2( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
	...
	if pSlideShot:EventTimer( 0.1 ) == true then
		...
		pSlideShot:SetTextBoxShow( true )
		pSlideShot:AddText2_LUA( true, "Shen Tianci", "呵呵～我也感觉这里空气清新了许多呢！", 0.11, "#C6600CC" )
...
function PF_STORYQUEST_ALL_3_10_STAGE0_SUB0_SHOT3( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
	...
	if pSlideShot:EventTimer( 0.1 ) == true then
		...
		pSlideShot:SetTextBoxShow( true )
		pSlideShot:AddText2_LUA( true, "Xiao Hu", "那还等什么，大家冲啊！！！", 0.11, "#C6600CC" )
