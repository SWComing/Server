STAGE_LIST = 
{
	...
	DUNGEON_MAP =
	{
		...
		STAGE4 =
		{
			SUB_STAGE0 = { 180, 0 ,FALSE,FALSE,"Texture_Road_gutou"},
		},
		STAGE5 =
		{
			SUB_STAGE0 = { 240, 0 ,TRUE,FALSE,"Texture_Road_gutou"},
		},
	},
	...
	STAGE4 =
	{
		WORLD_ID = WORLD_ID["WI_H_01_WILDERNESS_05"],
	...
	STAGE5 =
	{
		...
		READY_NPC = 
		{
			NPC_UNIT_ID["NUI_HYPOGEAL_WORM_KING_4"],
		},
		...
		SUB_STAGE0 =
		{
			...
			{
				{
					NPC_ID		= NPC_UNIT_ID["NUI_HYPOGEAL_WORM_KING_4"],
					START_POS	= { 16, },
					LEVEL		= 35,
					FOCUS_CAMERA	= TRUE,
					HAVE_BOSS_GAGE = TRUE,
