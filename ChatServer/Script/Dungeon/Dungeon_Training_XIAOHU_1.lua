...
function PF_STAGE0_SUB0_SHOT3( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
	...
	if pSlideShot:EventTimer( 1.1 ) == true then
		...
		pSlideShot:AddText_LUA( "O Ganoderma lucidum de madeira será certamente chutado longe. Esta é uma habilidade boa para escapar de ser atacado quando você está cercado por inimigos.", 3 )
		pSlideShot:SetShowEnterMark( true )
...
function PF_STAGE0_SUB0_SHOT6( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
	...
	if pSlideShot:EventTimer( 0.1 ) == true then
		...
		pSlideShot:AddText_LUA( "pressione a tecla de direção para baixo para mandar embora as setas neste momento.", 1 )
