--------所有人物 第三章 第十一幕
function CF_STORYQUEST_ALL_3_11_STAGE0_SUB0_TRIGGER0( pKTDXApp, pX2DungeonGame, pX2DungeonSubStage )
       if  pX2DungeonGame:IsNowQuest(900590) == true then
	return true 
...
function RF_STORYQUEST_ALL_3_11_STAGE0_SUB0_TRIGGER0( pKTDXApp, pX2DungeonGame, pX2DungeonSubStage )
	
	pSlideShot = pX2DungeonGame:GetSlideShot()
	pSlideShot:ScenStart_LUA( "PF_STORYQUEST_ALL_3_11_STAGE0_SUB0_SHOT", 0 )
...
-----------------剧情
function PF_STORYQUEST_ALL_3_11_STAGE0_SUB0_SHOT0( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )

	if pSlideShot:EventTimer( 0.1 ) == true then
		pParticle = pX2Data:GetUIMajorParticle()
	       	pSlideShot:AddSeqMap_LUA( "story1", pParticle:CreateSequence_LUA( "yuelinghappy", D3DXVECTOR3(0,0,0), D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) ) )
		...
		pSlideShot:AddText2_LUA( false, "月铃", "哇哈哈～好漂亮的枫林啊！！！我从来没有见到过这么多、这么漂亮的枫树。", 0.11, "#C6600CC" )
...
function PF_STORYQUEST_ALL_3_11_STAGE0_SUB0_SHOT1( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
	...
	if pSlideShot:EventTimer( 0.1 ) == true then
		...
		pSlideShot:SetTextBoxShow( true )
		pSlideShot:AddText2_LUA( true, "晓", "啊哈～真想枕着这厚厚的枫叶美美睡一觉呢！", 0.11, "#C6600CC" )
...
function PF_STORYQUEST_ALL_3_11_STAGE0_SUB0_SHOT2( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )

	if pSlideShot:EventTimer( 0.1 ) == true then
		pParticle = pX2Data:GetUIMajorParticle()
		pSlideShot:DeleteSeq_LUA( "story4" )
	        pSlideShot:AddSeqMap_LUA( "story7", pParticle:CreateSequence_LUA( "shentiancihappy", D3DXVECTOR3(0,0,0), D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) ) )
		...
		pSlideShot:SetTextBoxShow( true )
		pSlideShot:AddText2_LUA( true, "沈天赐", "终于走出来了，呵～这次在无底洞待了那么长时间，这突然走到外面感觉真是豁然开朗！", 0.11, "#C6600CC" )
...
function PF_STORYQUEST_ALL_3_11_STAGE0_SUB0_SHOT3( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
	...
	if pSlideShot:EventTimer( 0.1 ) == true then
		...
		pSlideShot:SetTextBoxShow( true )
		pSlideShot:AddText2_LUA( true, "二胖", "你们别啰嗦了，还是快赶路吧，不然我老姐发现我又跑了，追上来我就惨了！", 0.11, "#C6600CC" )
...
function PF_STORYQUEST_ALL_3_11_STAGE0_SUB0_SHOT4( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )

	if pSlideShot:EventTimer( 0.1 ) == true then
		pParticle = pX2Data:GetUIMajorParticle()
		pSlideShot:DeleteSeq_LUA( "story10" )
	        pSlideShot:AddSeqMap_LUA( "story13", pParticle:CreateSequence_LUA( "xiaohuhappy", D3DXVECTOR3(0,0,0), D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) ) )
		...
		pSlideShot:SetTextBoxShow( true )
		pSlideShot:AddText2_LUA( true, "小虎", "那就走吧！还等什么呢！", 0.11, "#C6600CC" )
...
function PF_STORYQUEST_ALL_3_11_STAGE0_SUB0_SHOT5( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )

	if pSlideShot:EventTimer( 0.1 ) == true then
		pParticle = pX2Data:GetUIMajorParticle()
		pSlideShot:DeleteSeq_LUA( "story13" )
	       	pSlideShot:AddSeqMap_LUA( "story16", pParticle:CreateSequence_LUA( "StoryTeshu01", D3DXVECTOR3(0,0,0), D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) ) )
		...
		pSlideShot:SetTextBoxShow( true )
		pSlideShot:AddText2_LUA( true, "大家", "冲啊！！！", 0.11, "#C6600CC" )
...
function PF_STORYQUEST_ALL_3_11_STAGE0_SUB0_SHOT6( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
