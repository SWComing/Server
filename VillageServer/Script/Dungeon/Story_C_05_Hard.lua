-----------------------任务剧情第三章第十幕
function CF_STORYQUEST_ALL_3_10_STAGE0_SUB0_TRIGGER0( pKTDXApp, pX2DungeonGame, pX2DungeonSubStage )

	  if  pX2DungeonGame:IsNowQuest(900580) == true then
	return true 
...
function RF_STORYQUEST_ALL_3_10_STAGE0_SUB0_TRIGGER0( pKTDXApp, pX2DungeonGame, pX2DungeonSubStage )
	
	pSlideShot = pX2DungeonGame:GetSlideShot()
	pSlideShot:ScenStart_LUA( "PF_STORYQUEST_ALL_3_10_STAGE0_SUB0_SHOT", 0 )
...
-----------------剧情
function PF_STORYQUEST_ALL_3_10_STAGE0_SUB0_SHOT0( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )

	if pSlideShot:EventTimer( 0.1 ) == true then
		pParticle = pX2Data:GetUIMajorParticle()
	        pSlideShot:AddSeqMap_LUA( "story1", pParticle:CreateSequence_LUA( "xiaonormal", D3DXVECTOR3(0,0,0), D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) ) )
		...
		pSlideShot:AddText2_LUA( true, "晓", "从这里就可以出去了。", 0.11, "#C6600CC" )
...
function PF_STORYQUEST_ALL_3_10_STAGE0_SUB0_SHOT1( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
	...
	if pSlideShot:EventTimer( 0.1 ) == true then
		...
		pSlideShot:SetTextBoxShow( true )
		pSlideShot:AddText2_LUA( true, "晓", "嗯～我都闻到了洞外的花香味呢！", 0.11, "#C6600CC" )
...
function PF_STORYQUEST_ALL_3_10_STAGE0_SUB0_SHOT2( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
	...
	if pSlideShot:EventTimer( 0.1 ) == true then
		...
		pSlideShot:SetTextBoxShow( true )
		pSlideShot:AddText2_LUA( true, "沈天赐", "呵呵～我也感觉这里空气清新了许多呢！", 0.11, "#C6600CC" )
...
function PF_STORYQUEST_ALL_3_10_STAGE0_SUB0_SHOT3( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )

	if pSlideShot:EventTimer( 0.1 ) == true then
		pParticle = pX2Data:GetUIMajorParticle()
		pSlideShot:DeleteSeq_LUA( "story7" )
	        pSlideShot:AddSeqMap_LUA( "story10", pParticle:CreateSequence_LUA( "xiaohunormal", D3DXVECTOR3(0,0,0), D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) ) )
		...
		pSlideShot:SetTextBoxShow( true )
		pSlideShot:AddText2_LUA( true, "小虎", "那还等什么，大家冲啊！！！", 0.11, "#C6600CC" )
...
function PF_STORYQUEST_ALL_3_10_STAGE0_SUB0_SHOT4( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
