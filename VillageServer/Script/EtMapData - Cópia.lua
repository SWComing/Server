...
g_pEtMapData:AddMapInfo
{
	...
	Stage0 = 
	{
		...
		WalkTransDestPos = 
		{
			{ VILLAGE_MAP_ID["VMI_QINGPU"],		{5600, 20, 0} },
		},
	},
	Stage1 = 
	{
...
g_pEtMapData:AddMapInfo
{
	...
	MinLevel	= 1,
	MaxLevel	= 60,
	VillageID	= VILLAGE_MAP_ID["VMI_LUOCHUAN"],
	RequireDungeonID	= DUNGEON_ID["DI_A_02_NORMAL"],
	...
	IncludeDungeonID = 
	{
		...
		DUNGEON_ID["DI_S_SECRET_E_NORMAL"],
		DUNGEON_ID["DI_S_SECRET_E_HARD"],
		DUNGEON_ID["DI_S_SECRET_E_EXPERT"],
		DUNGEON_ID["DI_S_SECRET_E_HELL"],
	},
	...
	Stage0 = 
	{
		...
		CommTransDestPos = {6050, 1860, 170},

		WalkTransDestPos = 
		{
			{ VILLAGE_MAP_ID["VMI_LUOCHUAN"],	{7477, 1900, 170} },
			{ VILLAGE_MAP_ID["VMI_BEILING"],	{4374, 1900, 170} },
		},
	},
	Stage1 = 
	{
...
g_pEtMapData:AddMapInfo
{
	...
	MinLevel	= 1,
	MaxLevel	= 60,
	VillageID	= VILLAGE_MAP_ID["VMI_BEILING"],
	RequireDungeonID	= DUNGEON_ID["DI_A_02_NORMAL"],
	...
	Stage0 = 
	{
		...
		WalkTransDestPos = 
		{
			{ VILLAGE_MAP_ID["VMI_BEILING"],	{4787, 1280, -125} },
		},
	},
	Stage1 = 
	{
...
g_pEtMapData:AddMapConnection
{
	MapPair  = { LOCAL_MAP_ID["LMI_BUZHOUSHAN"],VILLAGE_MAP_ID["VMI_LUOCHUAN"] },
	Distance = 1,
}

g_pEtMapData:AddMapConnection
{
	MapPair  = { VILLAGE_MAP_ID["VMI_LUOCHUAN"],LOCAL_MAP_ID["LMI_LUOCHUAN"] },
	Distance = 1,
}

g_pEtMapData:AddMapConnection
{
	MapPair  = { LOCAL_MAP_ID["LMI_LUOCHUAN"],VILLAGE_MAP_ID["VMI_BEILING"] },
	Distance = 1,
}

g_pEtMapData:AddMapConnection
{
	MapPair  = { VILLAGE_MAP_ID["VMI_BEILING"],LOCAL_MAP_ID["LMI_BEILING"] },
	Distance = 1,
}

g_pEtMapData:AddMapConnection
{
	MapPair  = { VILLAGE_MAP_ID["VMI_QINGPU"],VILLAGE_MAP_ID["VMI_WEDDING"] },
	Distance = 1,
}

g_pEtMapData:AddMapConnection
{
	MapPair  = { VILLAGE_MAP_ID["VMI_WEDDING"],LOCAL_MAP_ID["LMI_WEDDING"] },
	Distance = 1,
}
g_pEtMapData:AddMapConnection
{
...
g_pEtMapData:AddMapConnection
{
	MapPair  = { LOCAL_MAP_ID["LMI_MOYU"],VILLAGE_MAP_ID["VMI_XIANYUCHENG"] },
	Distance = 1,
}
-- 单位距离手续费
