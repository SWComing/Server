...
function PF_STORYQUEST_SHENTIANCI_1_1_STAGE0_SUB0_SHOT0( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
	...
	if pSlideShot:EventTimer( 0.1 ) == true then
		...
		pSlideShot:AddSeqMap_LUA( "story2", pParticle:CreateSequence_LUA( "shentiancinormal", D3DXVECTOR3(0,0,0), D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) ) )
		...
		pSlideShot:AddText2_LUA( true, "Shen Tianci", "师傅的话没错，连这么偏僻的地方竟然也隐藏着怪物。", 0.00001, "#C6600CC" )
...
function PF_STORYQUEST_SHENTIANCI_1_1_STAGE0_SUB0_SHOT1( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
	...
	if pSlideShot:EventTimer( 0.1 ) == true then
		...
		pParticle = pX2Data:GetUIMajorParticle()
	   	pSlideShot:AddSeqMap_LUA( "story5", pParticle:CreateSequence_LUA( "shentiancianger", D3DXVECTOR3(0,0,0), D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) ) )
		...
		pSlideShot:SetTextBoxShow( true )
		pSlideShot:AddText2_LUA( true, "Shen Tianci", "受死吧，你们这些怪物！", 0.00001, "#C6600CC" )
...
function PF_STORYQUEST_YUELING_1_1_STAGE0_SUB0_SHOT3( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
		...
		if pSlideShot:EventTimer( 0.1 ) == true then
			...
			pSlideShot:SetTextBoxShow( true )
			pSlideShot:AddText2_LUA( false, " Abelha pequeno", "小丫头，看你样子不会是和那臭小子是一伙的吧！？", 0.01, "#C6600CC" )
...
function PF_STORYQUEST_YUELING_1_1_STAGE0_SUB0_SHOT4( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
	...
	pSlideShot:DeleteSeq_LUA( "yueling1" )
		pParticle = pX2Data:GetUIMajorParticle()
	     	pSlideShot:AddSeqMap_LUA( "yueling4", pParticle:CreateSequence_LUA( "yuelinganger1", D3DXVECTOR3(0,0,0), D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) ) )
		...
		pSlideShot:SetTextBoxShow( true )
		pSlideShot:AddText2_LUA( true, "Yue ling", "不会是说的那小气鬼吧！", 0.01, "#C6600CC" )
		if pX2DungeonGame:PlayForceFeedBackEffect(FORCE_FEEDBACK_TYPE["FFT_ConstantForce"],5000,5000,8,0) == false then
			pX2DungeonGame:PlayXBOXForceEffect(32767, 0.5, 0)
		end
...
function PF_STORYQUEST_YUELING_1_1_STAGE0_SUB0_SHOT5( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
	...
	pSlideShot:DeleteSeq_LUA( "yueling4" )
		pParticle = pX2Data:GetUIMajorParticle()
	      	pSlideShot:AddSeqMap_LUA( "yueling7", pParticle:CreateSequence_LUA( "yuelinganger", D3DXVECTOR3(0,0,0), D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) ) )
		...
		pSlideShot:SetTextBoxShow( true )
		pSlideShot:AddText2_LUA( false, "Yue ling", "谁说我跟那自大的小气鬼是一伙的了！哼……", 0.01, "#C6600CC" )
		if pX2DungeonGame:PlayForceFeedBackEffect(FORCE_FEEDBACK_TYPE["FFT_ConstantForce"],5000,5000,8,0) == false then
			pX2DungeonGame:PlayXBOXForceEffect(32767, 0.5, 0)
		end
...
function PF_STORYQUEST_XIAO_1_1_STAGE0_SUB0_SHOT7( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
	...
	if pSlideShot:EventTimer( 0.1 ) == true then
		...
		pSlideShot:SetTextBoxShow( true )
		pSlideShot:AddText2_LUA( true, "Xiao", "这里怪物真多呀，真没有想到。我得赶在天黑前回村才行！", 0.00001, "#C6600CC" )
...
function PF_STORYQUEST_WU_1_1_STAGE0_SUB0_SHOT9( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
	...
	if pSlideShot:EventTimer( 0.1 ) == true then
		pParticle = pX2Data:GetUIMajorParticle()
		pSlideShot:AddSeqMap_LUA( "wu1", pParticle:CreateSequence_LUA( "wuanger", D3DXVECTOR3(0,0,0), D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) ) )
		...
		pSlideShot:SetTextBoxShow( true )
		pSlideShot:AddText2_LUA( true, "dança", "来吧，你们这些怪物，就让你们尝尝我的利刃！", 0.00001, "#C6600CC" )
		if pX2DungeonGame:PlayForceFeedBackEffect(FORCE_FEEDBACK_TYPE["FFT_ConstantForce"],5000,5000,8,0) == false then
			pX2DungeonGame:PlayXBOXForceEffect(32767, 0.5, 0)
		end
...
function PF_STORYQUEST_ERPANG_1_1_STAGE0_SUB0_SHOT11( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
	...
	if pSlideShot:EventTimer( 0.1 ) == true then
		...
		pSlideShot:SetTextBoxShow( true )
		pSlideShot:AddText2_LUA( true, "Er Pang", "é tão delicioso ...", 0.00001, "#C6600CC" )
...
function PF_STORYQUEST_ERPANG_1_1_STAGE0_SUB0_SHOT12( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
	...
	if pSlideShot:EventTimer( 0.1 ) == true then
		...
		pSlideShot:AddSeqMap_LUA( "erpang3", pParticle:CreateSequence_LUA( "erpanghappy", D3DXVECTOR3(0,0,0), D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) ) )
		...
		pSlideShot:SetTextBoxShow( true )
		pSlideShot:AddText2_LUA( true, "Er Pang", "可算是吃到这蜂蜜了，真甜啊！", 0.00001, "#C6600CC" )
...
function PF_STORYQUEST_ERPANG_1_1_STAGE0_SUB0_SHOT13( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
	...
	if pSlideShot:EventTimer( 0.1 ) == true then
		...
		pSlideShot:AddSeqMap_LUA( "erpang5", pParticle:CreateSequence_LUA( "erpangsurprise", D3DXVECTOR3(0,0,0), D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) ) )
		...
		pSlideShot:SetTextBoxShow( true )
		pSlideShot:AddText2_LUA( true, "Er Pang", "这些蜜蜂追到这里来了！硬着头皮上吧！", 0.00001, "#C6600CC" )
...
function PF_STORYQUEST_XIAOHU_1_1_STAGE0_SUB0_SHOT15( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
	...
	if pSlideShot:EventTimer( 0.1 ) == true then
		pParticle = pX2Data:GetUIMajorParticle()
		pSlideShot:AddSeqMap_LUA( "xiaohu1", pParticle:CreateSequence_LUA( "xiaohuanger", D3DXVECTOR3(0,0,0), D3DXVECTOR2(-1,-1), D3DXVECTOR2(-1,-1) ) )
		...
		pSlideShot:SetTextBoxShow( true )
		pSlideShot:AddText2_LUA( true, "Xiao Hu", "别挡路，你们这些可恶的东西。", 0.00001, "#C6600CC" )
		if pX2DungeonGame:PlayForceFeedBackEffect(FORCE_FEEDBACK_TYPE["FFT_ConstantForce"],5000,5000,8,0) == false then
			pX2DungeonGame:PlayXBOXForceEffect(32767, 0.5, 0)
		end
