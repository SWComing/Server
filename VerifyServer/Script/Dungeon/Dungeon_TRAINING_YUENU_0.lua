...
function PF_STAGE0_SUB0_SHOT1( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
	...
	if pSlideShot:EventTimer( 0.1 ) == true then
		...
		pSlideShot:AddText_LUA( "Clique Único na tecla de comando ataque leve.", 1 )
		pSlideShot:SetShowEnterMark( true )
...
function PF_STAGE0_SUB0_SHOT3( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
	...
	if pSlideShot:EventTimer( 1.1 ) == true then
		pSlideShot:ClearWaitingKeyPress()		
		pSlideShot:AddText_LUA( "Ataque ligeiro tem velocidade rápida, mas o alcance é pequeno e atacar a intensidade lesão também é pequena.", 3 )
...
function PF_STAGE0_SUB0_SHOT4( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
	...
	if pSlideShot:EventTimer( 0.1 ) == true then
		...
		pSlideShot:AddText_LUA( "Único clique na tecla de ataque forte dessa vez.", 3 )
		pSlideShot:SetShowEnterMark( true )
...
function PF_STAGE0_SUB0_SHOT7( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
	...
	if pSlideShot:EventTimer( 0.1 ) == true then
		...
		pSlideShot:AddText_LUA( "Pressione a tecla atalho durante a corrida ou pulo para o ataque.", 3 )
		pSlideShot:SetShowEnterMark( true )
...
function PF_STAGE0_SUB0_SHOT8( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
	...
	if pSlideShot:EventTimer( 0.1 ) == true then
		...
		pSlideShot:AddText_LUA( "Agora, vou lhe ensinar o método contínuo de ataque.", 3 )
		pSlideShot:SetShowEnterMark( true )
...
function PF_STAGE0_SUB0_SHOT11( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
	...
	if pSlideShot:EventTimer( 1.1 ) == true then
		...
		pSlideShot:ClearWaitingKeyPress()
		pSlideShot:AddText_LUA( "Muito Bem! Parece que você é realmente inteligente. \n não há quase nenhuma falha para ataque contínuo, e proporciona ao inimigo lesão extremamente enorme.", 3 )
		pSlideShot:SetShowEnterMark( true )
...
function PF_STAGE0_SUB0_SHOT12( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
	...
	if pSlideShot:EventTimer( 0.1 ) == true then
		...
		pSlideShot:AddText_LUA( "Vamos aprender alguma habilidade ataque contínuo com certa dificuldade. \n essas habilidades devem entender bem o ritmo.", 3 )
		pSlideShot:SetShowEnterMark( true )
