...
function PF_STAGE0_SUB0_SHOT0( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
	...
	if pSlideShot:EventTimer( 1.1 ) == true then
		...
		pSlideShot:AddText_LUA( "Cada figura terá sua própria habilidade especial. Então, aprenda a ensinar a habilidade contra-ataque. Depois de aprender isso, você poderá usá-los no momento crucial.", 3 )
...
function PF_STAGE0_SUB0_SHOT5( pKTDXApp, pX2DungeonGame, pX2Data, pSlideShot )
	...
	if pSlideShot:EventTimer( 0.1 ) == true then
		...
		pSlideShot:AddWaitingUserState_LUA( SHENTIANCI_JIANSHI_STATE_ID["ESSI_REVENGE_ATTACK"], 3, stringIndex, " Contra-ataque" )
